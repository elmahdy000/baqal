...
export default async function AdminHomePage() {
  ...
  const stats = [
    { label: "إجمالي البقالات", value: totalStores.toString() },
    { label: "البقالات النشطة", value: activeStores.toString() },
    { label: "البقالات الموقوفة", value: suspendedStores.toString() },
    { label: "طلبات اليوم", value: ordersToday.toString() },
    { label: "مبيعات اليوم", value: formatEGP(salesToday) },
    { label: "عدد العمارات", value: buildingsCount.toString() },
    { label: "أكواد QR", value: qrCount.toString() },
    { label: "عدد العملاء", value: customersCount.toString() },
  ];
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
        ...
        <Card className="border-2 border-[#C6FF3A] bg-lime-50">
          <CardContent className="p-5">
            ...
            <Link
              ...
              className="mt-1 inline-block text-xs text-gray-700 underline"
            >
              فتح صفحة التسويات
            </Link>
          </CardContent>
